				...
				<div class="row">
				   ...
				   <div class="col-md-8">
                         ...
                         mysql_select_db($mysql_database,$bd) or die("<div class='alert alert-success' role='alert'>Opps somthing went wrong.</div>");
						      ...
						      echo "<div class='alert alert-warning' role='alert' style='text-align:center;font-weight:bold;color:black;'> Delete A Product Whose Product Purchase ID: ".'<b>'.$pro_sl_no." Product Name: " .$Pro_Name . "<br> Date: " . $Pro_Date . " Net Amount ". $Pro_Net_Amount .'</b>'." </div>";
          
						      
						      $sql = "DELETE FROM product WHERE Pro_Sl_No='$pro_sl_no'";
