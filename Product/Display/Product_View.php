   ...
   <br>
		...
		<div class="row">
		  ...
		  <div class="row">
		   <br>
		   <div class="col-md-12">
		      <?php  echo "<a href='http://localhost/Employee_Product/Registration_SignIn/logout.php' class='btn btn-danger' role='button'>Log Out</a>"."&nbsp;&nbsp;"."<a href='http://localhost/Employee_Product/Registration_SignIn/SignIn_Successful.php' class='btn btn-danger' role='button'><b>Main Entry</b></a>"; ?>
		   <br>
		   <br>
		    <?php
			            echo "<br>";
		    ...
		    ?>
     		...
     		<table class="table table-hover table-bordered" style="font-weight: bold;text-align:center;">   
            	    <thead class="alert alert-info">
            	     <tr>
            	      <td><b><?php echo "Manufacture_Agenc_Name:  ".$Row['MA_Name']; ?></b><br><?php echo "Manufacture_Agency_Address:  ".$Row['MA_Address']; ?><br><?php echo "Manufacture_Agency_PhoneNo.:  ".$Row['MA_PhoneNo']; ?><br><?php echo "Manufacture_Agency_TinNo:  ".$Row['MA_TinNo']; ?></td>
            	      <td><b><?php echo "Purchase_Agency_Name:  ".$Row['PA_Name']; ?> <br> <?php echo "Purchase_Agency_Rou._Name:  ".$Row['PA_Route_Name']; ?> <br> <?php echo "Purchase_Agency_PhoneNo.:  ".$Row['PA_PhoneNo']; ?> <br><?php echo "Purchase_Agency_TinNo.:  ".$Row['PA_TinNo']; ?></b></td>
            	     </tr>
            	    </thead>
           </table>
        ...
        ?>   
		   <table class="table table-hover table-bordered" style="font-weight: bold;">
            ...
            <thead class="alert alert-danger">
		      <tr>
		        <th class="col-md-0.9">Date</th>
		        <th class="col-md-0.1">Sl_No</th>
		        ...
		        <th class="col-md-0.5">Edit</th>
		        <th class="col-md-0.5">Delete</th>
		      </tr>
			 </thead> 
			    <?php 
						$sum1 = 0;
						...
						<tr class='success'>
		                    ...
		                    <td><?php echo $row['Pro_Sl_No'] ?></td>
		                  	...
		                  	?></td>
		                  	<td><a class="btn btn-warning" href="http://localhost/Employee_Product/Product/Update/Edit.php?Pro_Sl_No=<?php echo $row['Pro_Sl_No'] ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span><!-- <b>Edit</b> --></a></td>
		                  	<td><a class="btn btn-danger" href="http://localhost/Employee_Product/Product/Are-You-Sure-Product/Sure.php?Pro_Sl_No=<?php echo $row['Pro_Sl_No'] ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span><!-- <b>Delete</b> --></a></td>
		                </tr> 
			           <?php 
			           }
			         ?>
			   ...
			   <?php echo '<a class="btn btn-danger" style="background-color:#696969;" href="http://localhost/Employee_Product/Product/Product_index.php"><b>Product Purchase Entry</b></a>'."&nbsp;"."&nbsp;"
    		              .'<a class="btn btn-danger" style="background-color:#696969;" href="http://localhost/Employee_Product/Product/Search/Product_Name_Search.php"><b>Product Search</b></a>'.
			              "&nbsp;"."&nbsp;".'<a class="btn btn-danger" style="background-color:#696969;" href="http://localhost/Employee_Product/Product/Print/Product_Print.php"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>'  ?>
			   <br>
			   <br>
