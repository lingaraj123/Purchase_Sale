		...
		<html lang="en">
     	 ...
     	 <div class="col-md-12">
     	  <nav class="navbar navbar-default">
				...
				<div class="row">
				   <div class="col-md-2"> 
                    <?php  echo '<a class="btn btn-info" href="http://localhost/Employee_Product/Product/Product_index.php"><b>Insert New <br>Purchase Record</b></a>'; ?>
				   </div>		
				   <div class="col-md-8">
							...
							<br>
							<br>
							<form class="form-search" method="post" action="date_search.php">
								<div class="input-group">
									  <input type="date" name="search" placeholder="Enter Date." class="form-control">
							...
							<table class="table table-hover table-bordered" style="font-weight: bold;">
						     ...
						     <?php
								...
								if(isset($_POST['search'])){
								    ...
								    $sql = "SELECT * FROM product WHERE Date LIKE '$pro_date'";
					...
					<div class="col-md-2"><?php echo "<a href='http://localhost/Employee_Product/Registration_SignIn/logout.php' class='btn btn-info' role='button' style='text-align:right;'>Log Out</a>".'<br><br>'.'<a class="btn btn-info" href="http://localhost/Employee_Product/Product/Search/Product_Name_Search.php"><b>Product Name Search</b></a>';?></div>		
				</div>
			</div>	
	 <script>
