				...
				<div class="row">
				   ...
				   <div class="col-md-8">
                         ...
                         mysql_select_db($mysql_database,$bd) or die("<div class='alert alert-success' role='alert'>Opps somthing went wrong.</div>");
						      ...
						      echo "<b style='color:red;'>Deleted Sales Product id is: </b>".$pro_sl_id."<br>";
						      
						      $sql1 = "SELECT Pro_Name , Sales_Date , Bill_Amt FROM sales WHERE Sales_ID='$pro_sl_id'";
...

							  {
							  	while($row = mysql_fetch_array($result)){
							  		echo "<b>Product Name: </b>".$row['Pro_Name']."<br>";
							  		echo "<b>Bill Amount: </b>".$row['Bill_Amt'];
							  	}
							  	
							  }
						      	
						      $sql = "DELETE FROM sales WHERE Sales_ID='$pro_sl_id'";
