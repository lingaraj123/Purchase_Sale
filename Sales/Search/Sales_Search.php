     	  ...
     	  <nav class="navbar navbar-default">
				...
				<div class="row">
				   ...
				   <div class="col-md-8">
							...
							<br>
							<br>
							<form class="form-search" method="post" action="Sales_Search.php">
								<div class="input-group">
									  <input type="text" name="search" placeholder="Enter Pro. Name" class="form-control">
						  ...
						  <?php
								...
								if(isset($_POST['search'])){
								    ...
								    $sql = "SELECT * FROM sales WHERE Pro_Name LIKE '$search'";
