            ...
            <div class="col-md-6" align="justify">
				   <?php
						...
						if(isset($_POST['submit'])){
							...
							$emp_mobileno = $_POST['Emp_Mobile_No'];
							$emp_designation = $_POST['Emp_Designation'];
							$emp_salary = $_POST['Emp_Salary'];
							$emp_address = $_POST['Emp_Address'];
						}
						
						$emp_firstname = stripslashes($emp_firstname);
						$emp_lastname = stripslashes($emp_lastname);
						$emp_mobileno = stripslashes($emp_mobileno);
						$emp_designation = stripslashes($emp_designation);
						$emp_salary = stripslashes($emp_salary);
						$emp_address = stripslashes($emp_address);
						
						$emp_firstname = mysql_real_escape_string($emp_firstname);
						$emp_lastname = mysql_real_escape_string($emp_lastname);
						$emp_mobileno = mysql_real_escape_string($emp_mobileno);
						$emp_designation = mysql_real_escape_string($emp_designation);
						$emp_salary = mysql_real_escape_string($emp_salary);
						$emp_address = mysql_real_escape_string($emp_address);
						
						echo "Emp_FirstName: "."<b style='color:red'>".$emp_firstname."</b>"."<br>".
						     "Emp_LastName: "."<b style='color:red'>".$emp_lastname."</b>"."<br>".
						     "Emp_Mobile_No: "."<b style='color:red'>".$emp_mobileno."</b>"."<br>".
						     "Emp_Designation: "."<b style='color:red'>".$emp_designation."</b>"."<br>".
						     "Emp_Salary: "."<b style='color:red'>".$emp_salary."</b>"."<br>".
						     "Emp_Address: "."<b style='color:red'>".$emp_address."</b>";
						
						$sql = "INSERT INTO employee (Emp_FirstName,Emp_LastName,Emp_Mobile_No,Emp_Designation,Emp_Salary,Emp_Address) VALUES('$emp_firstname','$emp_lastname','$emp_mobileno','$emp_designation','$emp_salary','$emp_address')";
				...
				?>
				 ...
				 <br>
				 <br>
				 <a class="btn btn-info" href="http://localhost/Employee_Product/Employee/Display/view.php"><b>View</b></a> 
         </div>
         <div class="col-md-3"></div>
       </div>
