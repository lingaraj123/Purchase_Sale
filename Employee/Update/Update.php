				   ...
				   <div class="col-md-8">
				     <?php
						  ...
						  if(isset($_POST['update'])){
						  	...
						  	$sql2 = "UPDATE employee SET Emp_FirstName='$emp_firstname',Emp_LastName='$emp_lastname',Emp_Mobile_No='$emp_mobileno',Emp_Designation='$emp_designation',Emp_Salary='$emp_salary',Emp_Address='$emp_address' WHERE Emp_ID='$emp_id'";
						  }
						  echo "<div class='alert alert-success' role='alert' style='text-align:center;'>You Entered Data is:</div>"."Employee ID: ".$emp_id."<br>"
						  		." Employee FirstName: ".$emp_firstname."<br>"." Employee LastName: ".$emp_lastname."<br>"." Employee Mobile No.:".$emp_mobileno."<br>"." Employee Designation: ".$emp_designation."<br>"." Employee Salary: ".$emp_salary."<br>"." Employee Address: ".$emp_address;
							if(mysql_query($sql2)){
							echo  "<h2 style='color:green;'>Data Updation Successful</h1>";
                           }

						?>
						<a class="btn btn-info" href="http://localhost/Employee_Product/Employee/Display/Employee_view.php"><b>View</b></a>
				   </div>
				   <div class="col-md-2"></div>
				</div>
