          		...
          		<div class="container">
          		  <div class="row">
          		    ...
          		    <div class="col-md-8">
          		     ...
          		     $SQL = "SELECT * FROM sales WHERE Sales_ID='$pro_sl_id'";
          		     ...
          		     $Sales_Date = $ROW['Sales_Date'];
          		      ...
          		      echo "<div class='alert alert-warning' role='alert' style='text-align:center;font-weight:bold;color:black;'>Are You Sure, 
			                		You Want To Delete A Sale Whose Sales ID: ".'<b>'.$pro_sl_id." Product Name: " .$Pro_Name . " Sales Date: " . $Sales_Date .'</b>'." </div>"
          		     ...
          		     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          		     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          		     <a href="http://localhost/Employee_Product/Sales/Delete/Sales_Delete.php?Sales_ID=<?php echo $pro_sl_id; ?>" class="btn btn-danger">Yes</a>&nbsp;&nbsp;<a href="http://localhost/Employee_Product/Sales/Display/Sales_View.php" class="btn btn-danger">No</a>
          		    </div>
          		    <div class="col-md-2"></div>
          		  </div>
          		</div>	
