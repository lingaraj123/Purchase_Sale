				...
				<div class="row">
				   ...
				   <div class="col-md-8">
                         ...
                         mysql_select_db($mysql_database,$con) or die("<div class='alert alert-success' role='alert'>Opps somthing went wrong.</div>");
							  ...
							  if(isset($_GET['Manu_Purchase_id'])){
								$Manu_Purchase_id = htmlspecialchars($_GET['Manu_Purchase_id']);
							  }
							  
							
						      echo "Delete Manufacture purchase ".$Manu_Purchase_id."<br>";
						      	
						      $sql = "DELETE FROM manufacture_purchase WHERE Manu_Purchase_id = '$Manu_Purchase_id'";
							
							  if(mysql_query($sql)){
							 	echo "<h2 style='color:green;'>Data Deleted successful</h1>";
							  }
							  
							 else{
							 	echo "Data Unsuccessful Deleted";
							 }
							
							 mysql_close($con);
			           	 ?>
			           	 <br>
			           	 <a class="btn btn-info" href="http://localhost/Employee_Product/Agency_Details/Display/Agency_view.php"><b>Agency_View</b></a>
