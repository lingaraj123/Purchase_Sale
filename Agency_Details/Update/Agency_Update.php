				   ...
				   <div class="col-md-8">
				     <?php
						  ...
						  if(isset($_POST['update'])){
						  	$Manu_Purchase_id = $_POST['Manu_Purchase_id'];
							...
							$PA_TinNo = $_POST['PA_TinNo'];
						  	$sql2 = "UPDATE manufacture_purchase SET MA_Name ='$MA_Name',
																  	 MA_Address ='$MA_Address',
																  	 MA_PhoneNo ='$MA_PhoneNo',
																  	 MA_TinNo ='$MA_TinNo',
																  	 PA_Name ='$PA_Name',
																  	 PA_Route_Name ='$PA_Route_Name',
																  	 PA_PhoneNo ='$PA_PhoneNo',
																  	 PA_TinNo ='$PA_TinNo'
						             WHERE Manu_Purchase_id='$Manu_Purchase_id'";
						  }
						  echo "<div class='alert alert-success' role='alert'>You Entered Data is:</div>".$Manu_Purchase_id."<br>"
						  		.$MA_Name."<br>".$MA_Address."<br>".$MA_PhoneNo."<br>".$MA_TinNo."<br>".$PA_Name."<br>".$PA_Route_Name."<br>".$PA_PhoneNo."<br>".$PA_TinNo;
							if(mysql_query($sql2)){
							echo  "<h2 style='color:green;'>Data Updation Successful</h1>";
                           }

						?>
						<a class="btn btn-danger" href="http://localhost/Employee_Product/Agency_Details/Display/Agency_view.php"><b>Agency View</b></a>
				   </div>
				   <div class="col-md-2">
				    <?php mysql_close($con) ?>
				   </div>
